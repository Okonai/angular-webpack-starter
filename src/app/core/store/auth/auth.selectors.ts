...
export const getAuthState = createSelector(
  ...
  (state: fromStore.MainState) => state.auth
);
 ...
 * @return {User}
 */
export const getAuthenticatedUser = createSelector(getAuthState, fromAuth.getAuth, (auth) => {
  return auth.user;
});
 ...
 * @return {User}
 */
export const getAuthLoaded = createSelector(getAuthState,  fromAuth.getAuth, (auth) => {
  return auth.loaded;
});
